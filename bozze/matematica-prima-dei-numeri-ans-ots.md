...
- che possiamo prevedere il futuro matematico di un bambino guardando come osserva dei punti;
- che dobbiamo allenare i neonati con schede;
- che l'intelligenza matematica sia gia' decisa a 6 mesi.

Dice invece:

- che il senso approssimato del numero e' una componente reale dello sviluppo;
- che puo' avere un rapporto con competenze successive;
- che l'ambiente educativo puo' offrire esperienze ricche senza anticipare la scuola.
...
- "Ci sono tre cubi."
- "Una mano, due mani."
- "Un cucchiaio per te, uno per papa'."
...
Accorgersi che un cubo che cade e' gia' fisica.
Accorgersi che una scatola che si svuota e' gia' quantita'.
